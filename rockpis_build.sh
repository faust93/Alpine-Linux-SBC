...
UBOOT_BRANCH="stable-4.4-rockpis-v1.3"
UBOOT_CONFIG="rock-pi-s-rk3308"
...
unit: sectors
first-lba: 2048
part1 : start=28768, size=81072, uuid=614e0000-0000-4b53-8000-1d28000054a9, type=0FC63DAF-8483-4772-8E79-3D69D8477DE4, name=boot, bootable
...
build_uboot()
{
    ...
    ./tools/loaderimage --pack --uboot ./u-boot-dtb.bin uboot.img 0x600000 --size 1024 1
    ./tools/mkimage -n rk3308 -T rksd -d ../../rkbin/rk3308_ddr_589MHz_uart0_m0_v1.26.bin idbloader.img
    cat ../../rkbin/rk3308_miniloader_v1.36_sd.bin >> idbloader.img
...
[BL31_OPTION]
SEC=1
PATH=../../rkbin/rk3308_bl31_v2.10.elf
ADDR=0x00010000
[BL32_OPTION]
SEC=0
[BL33_OPTION]
...
EOF
    ...
    ../../tools/trust_merger --size 1024 1 trust.ini
...
dd if=${OUT}/idbloader.img of="$OUT/$IMG_MEDIA" seek=64 conv=notrunc
dd if=${OUT}/uboot.img of="$OUT/$IMG_MEDIA" seek=16384 conv=notrunc
dd if=${OUT}/trust.img of="$OUT/$IMG_MEDIA" seek=24576 conv=notrunc
